...
def initialization():
    ...
    c = -0.000000000001  # where C is a small constant such  fitness values are larger than C
    ...
    y = "100000*z[0]**2 + z[1]**2 + z[2]**2 + z[3]**2 + z[4]**2"
    # y = "z[0]**2 + z[1]**2 + z[2]**2 + z[3]**2 + z[4]**2 +
    # math.sin(z[0]) + math.sin(z[1]) + math.sin(z[2]) + math.sin(z[3]) + math.sin(z[4]) + 40"
